        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <p>
                        <div class="card">
                          <img class="card-img-top" src=<?=TopRatedMovies(0)['images']['banner']?>>
                          <div class="card-body">
                              <h5 class="card-title">#1 - <a href="serie.php?slug=<?=TopRatedMovies(0)['slug']?>"><?= TopRatedMovies(0)['name']?></a></h5>
                              <p class="card-text"><i class="fa fa-star text-info"></i> La série est notée <?=round(TopRatedMovies(0)['statistics']['rating'],1)?> / 5</p>
                          </div>
                        </div>
                    </p>
                    <p>
                        <div class="card">
                          <img class="card-img-top" src=<?=TopRatedMovies(1)['images']['banner']?>>
                          <div class="card-body">
                              <h5 class="card-title">#2 - <a href="serie.php?slug=<?=TopRatedMovies(1)['slug']?>"><?= TopRatedMovies(1)['name']?></a></h5>
                              <p class="card-text"><i class="fa fa-star text-info"></i> La série est notée <?=round(TopRatedMovies(1)['statistics']['rating'],1)?> / 5</p>
                          </div>
                        </div>
                    </p>
                    <p>
                        <div class="card">
                          <img class="card-img-top" src=<?=TopRatedMovies(2)['images']['banner']?>>
                          <div class="card-body">
                              <h5 class="card-title">#3 - <a href="serie.php?slug=<?=TopRatedMovies(2)['slug']?>"><?= TopRatedMovies(2)['name']?></a></h5>
                              <p class="card-text"><i class="fa fa-star text-info"></i> La série est notée <?=round(TopRatedMovies(2)['statistics']['rating'],1)?> / 5</p>
                          </div>
                        </div>
                    </p>
                    <p>
